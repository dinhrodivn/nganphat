...
$languageStrings = array(
	...
	'LBL_CHARACTER_ENCODING' => 'Bảng mã',
	...
	'LBL_SELECT_MERGE_FIELDS' => 'Chọn các trường phù hợp để tìm các bản ghi trùng lặp',
	'LBL_AVAILABLE_FIELDS' => 'Các trường có sẵn',
	'LBL_SELECTED_FIELDS' => 'Các trường được so khớp',
	'LBL_NEXT_BUTTON_LABEL' => 'Tiếp theo',
	'LBL_IMPORT_STEP_4' => 'Step 4',
	'LBL_IMPORT_STEP_4_DESCRIPTION' => 'Map the Columns to Module Fields',
	'LBL_FILE_COLUMN_HEADER' => 'Phần đầu',
	'LBL_ROW_1' => 'Hàng 1',
	'LBL_CRM_FIELDS' => 'Các trường CRM',
	'LBL_DEFAULT_VALUE' => 'Giá trị mặc định',
    'LBL_IMPORT_MAP_FIELDS'=>'Liên kết các cột với các trường của CRM',
	'LBL_SAVE_AS_CUSTOM_MAPPING' => 'Lưu làm bản tuỳ chỉnh',
    'LBL_DUPLICATE_RECORD_HANDLING' => 'Xử lý bản ghi trùng lặp',
    'LBL_USE_SAVED_MAPS'=>'Sử dụng Bản đã Lưu',
	...
	'LBL_SELECT_SAVED_MAPPING' => 'Chọn đường dẫn đã lưu',
    ...
    'LBL_FIELD_MAPPING'=>'Dẫn đến trường',
    'LBL_IMPORT_LINEITEMS_CURRENCY' =>'Đơn vị tiền tệ',
