<?php /* Smarty version Smarty-3.1.7, created on 2022-11-15 16:35:52
         compiled from "/Users/dinhnguyen/localhost/fpt_cloud/vtiger/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12320037776373bfe803d151-96667800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '94b910dc139fd2a0bd3e09df604b76fab319a456' => 
    array (
      0 => '/Users/dinhnguyen/localhost/fpt_cloud/vtiger/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl',
      1 => 1627027149,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12320037776373bfe803d151-96667800',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6373bfe818726',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6373bfe818726')) {function content_6373bfe818726($_smarty_tpl) {?>
...
</a><?php }else{ ?><a href=""><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
...
</a><?php }?><?php }elseif($_REQUEST['view']!='List'&&$_REQUEST['module']=='Users'){?><?php if ($_REQUEST['view']=='PreferenceEdit'){?><a href="<?php echo ((((("index.php?module=").($_REQUEST['module'])).('&parent=')).($_REQUEST['parent'])).('&view=PreferenceDetail&record=')).($_REQUEST['record']);?>
...
<?php }?>&nbsp;</a><a href=""><span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php if ($_REQUEST['view']=='Edit'){?><?php if ($_smarty_tpl->tpl_vars['RECORD']->value){?><?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }?></a><?php }else{ ?><a href=""><?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->getName();?>
</a><?php }?><?php }elseif($_smarty_tpl->tpl_vars['URL']->value&&strpos($_smarty_tpl->tpl_vars['URL']->value,$_REQUEST['view'])==''){?><a href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
"><?php if ($_REQUEST['extensionModule']){?><?php echo $_REQUEST['extensionModule'];?>
<?php }else{ ?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
<?php $_tmp5=ob_get_clean();?><?php echo vtranslate($_tmp5,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?></a>&nbsp;<a href=""><span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['RECORD']->value){?><?php if ($_REQUEST['view']=='Edit'){?><?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 :&nbsp;<?php }?><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getName();?>
<?php }?></a><?php }else{ ?>&nbsp;<?php if ($_REQUEST['extensionModule']){?><?php echo $_REQUEST['extensionModule'];?>
<?php }else{ ?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
...
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?></li><?php } ?><?php if (!empty($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEWSETTING'])&&(count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEWSETTING'])>0)){?><?php if (empty($_smarty_tpl->tpl_vars['QUALIFIEDMODULE']->value)){?><?php $_smarty_tpl->tpl_vars['QUALIFIEDMODULE'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE']->value, null, 0);?><?php }?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li><?php } ?></ul></div></li><?php }?><?php $_smarty_tpl->tpl_vars['RESTRICTED_MODULE_LIST'] = new Smarty_variable(array('Users','EmailTemplates'), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEWBASIC'])&&(count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEWBASIC'])>0)&&(!in_array($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['RESTRICTED_MODULE_LIST']->value))){?><?php if (empty($_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value)){?><?php $_smarty_tpl->tpl_vars['QUALIFIED_MODULE'] = new Smarty_variable(('Settings:').($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php }?><?php  $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->_loop = false;
